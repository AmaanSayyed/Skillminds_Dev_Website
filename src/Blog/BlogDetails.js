                ...
                <div className="col-xxl-8 col-lg-7">
                    <div className="th-blog blog-single">
                        ...
                        <div className="blog-content">
                            ...
                            <h2 className="blog-title">Unsatiable entreaties may collecting Power.</h2>
                            ...
                            <h3 className="h4 mt-40">Dalky is the only theme you will ever need</h3>
                            ...
                            <p className="mb-n2">Completely seize seamless e-tailers whereas mission-critical ideas. Intrinsicly negotiate
                    ...
                    <div className="th-comments-wrap ">
                        <h2 className="blog-inner-title h3"><i className="far fa-comments"></i> Comments (03)</h2>
                            ...
                            <li className="th-comment-item">
                                <div className="th-post-comment">
                                    ...
                                    <div className="comment-content">
                                        ...
                                        <p className="text">Collaboratively empower multifunctional e-commerce for prospective applications. Seamlessly productivate plug and play markets.</p>
                                    ...
                                    <li className="th-comment-item">
                                        <div className="th-post-comment">
                                            ...
                                            <div className="comment-content">
                                                ...
                                                <p className="text">Competently provide access to fully researched methods of empowerment
                            ...
                            <div className="recent-post-wrap">
                                ...
                                <div className="recent-post">
                                    ...
                                    <div className="media-body">
                                        ...
                                        <div className="recent-post-meta">
                                            <a href="blog.html"><i className="fal fa-calendar-days"></i>23 June, 2024</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
