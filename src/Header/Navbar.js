          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-auto">
              <div className="header-logo">
                <a href="/">
                  <span data-mask-src="./Skillminds_Dev_Website/assets/img/skillminds_logo.png"></span>
                  <img
                    src="./Skillminds_Dev_Website/assets/img/skillminds_logo.png"
                    alt="Webteck"
                    style={{ width: "12rem" }}
                  />
                </a>
            ...
            <div className="col-auto">
              <nav className="main-menu style2 d-none d-lg-inline-block">
                <ul>
                  ...
                  <li className="menu-item-has-children">
                    <a className="tw-text-slate-700">Career</a>
                    <ul className="sub-menu">
                      <li>
