...
const Footer = () => {
    return (
        <footer className="footer-wrapper footer-layout5 footer-layout12 footer-layout14" data-bg-src="./Skillminds_Dev_Website/assets/img/bg/footer_bg.jpg">
                    ...
                    <div className="col-md-6 col-xl-auto">
                        <div className="widget footer-widget">
                            ...
                            <div className="th-widget-about">
                                ...
                                <p className="footer-info"><a className="text-inherit" href="mailto:webteck@gmail.com">info@skillminds.in</a></p>
