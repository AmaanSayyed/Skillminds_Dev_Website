...
const Contents = () => {
    ...
    return ( 
        <div
      className="th-hero-wrapper hero-16"
      id="hero"
      data-bg-src=""
    >
              ...
              <div className="hero-style16">
                <span className="sub-title">
                  <div className="icon-masking me-2">
                    <img src="./Skillminds_Dev_Website/assets/img/theme-img/title_shape_4.svg" alt="shape" />
                  </div>
                ...
                <div className="btn-group">
                  <Link to="/contact-us" className="th-btn style-radius text-capitalize">
                    Submit Enquiry
                  </Link>
                  <div className="about-client-box style2 mb-sm-0 mb-3">
                    <div className="client-thumb-group">
                      <div className="thumb">
                        <img src="./Skillminds_Dev_Website/assets/img/profile_rv_1.jpg" alt="avater" />
                      </div>
                      <div className="thumb">
                        <img src="./Skillminds_Dev_Website/assets/img/profile_rv_2.jpg" alt="avater" />
                      </div>
                      <div className="thumb">
                        <img src="./Skillminds_Dev_Website/assets/img/profile_rv_1.jpg" alt="avater" />
                      </div>
                ...
                <div className="hero-counter_wrapp">
                  <div className="hero-counter">
                    ...
                    <span className="hero-counter_text">Happily active client’s</span>
                  </div>
                  <div className="hero-counter">
                    <h2 className="counter-title mb-0">
                      <span className="counter-number">25</span>
                    </h2>
                    <span className="hero-counter_text">Years of experience in startup building</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-xl-6">
              <div className="th-hero-image">
                <div className="th-hero-thumb">
                  <img src="./Skillminds_Dev_Website/assets/img/hero/hero_img_15_1.png" alt="img" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="shape-mockup d-none d-xl-block" data-bottom="8%" data-left="4%">
        <img src="./Skillminds_Dev_Website/assets/img/shape/shape_7.png" alt="shape" />
      </div>
      <div className="shape-mockup movingX d-none d-xl-block" data-top="54%" data-right="44%">
        <img src="./Skillminds_Dev_Website/assets/img/shape/shape_8.png" alt="shape" />
      </div>
      <div className="shape-mockup spin d-none d-xl-block" data-bottom="14%" data-right="6%">
        <img src="./Skillminds_Dev_Website/assets/img/shape/shape_9.png" alt="shape" />
      </div>
    </div>
