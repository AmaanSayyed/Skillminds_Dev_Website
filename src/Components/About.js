...
<div>
            ...
            <div className="row">
                <div className="col-xl-6 mb-30 mb-xl-0">
                    <div className="img-box17 pe-xl-5">
                        <div className="img1">
                            <img src="./Skillminds_Dev_Website/assets/img/normal/about_15_1.jpg" alt="About"/>
                        </div>
                    </div>
                </div>
                <div className="col-xl-6">
                    ...
                    <div className="about-feature-wrap style5">
                        <div>
                            <div className="about-feature style5">
                                <div className="about-feature_icon">
                                    <img src="./Skillminds_Dev_Website/assets/img/icon/about_feature_2_1.svg" alt="Icon"/>
                                </div>
                            ...
                            <div className="about-feature style5">
                                <div className="about-feature_icon">
                                    <img src="./Skillminds_Dev_Website/assets/img/icon/about_feature_2_2.svg" alt="Icon"/>
                                </div>
                                <div className="media-body">
                        ...
                        <div className="about-img">
                            <img src="./Skillminds_Dev_Website/assets/img/normal/about_15_2.jpg" alt=""/>
                        </div>
                    </div>
    ...
    <div className="shape-mockup" data-bottom="0%" data-right="0%"><img src="./Skillminds_Dev_Website/assets/img/shape/about_shape.png" alt="shape"/>
    </div>
    </section>
</div>
